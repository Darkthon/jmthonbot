    ...
    async def do_pm_permit_action(chat_id, event, sender):
        ...
        if PMMENU:
            if Config.CUSTOM_PMPERMIT_TEXT:
                ...
                USER_BOT_NO_WARN = (
                    f"⌁ 𝙟𝙢𝙩𝙝𝙤𝙣  𝙨𝙤𝙪𝙧𝙘𝙚 ⌁ \n𓍹⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁⌁𓍻\n ههلا  {mention} ❝\n  انا مشغول حاليا لا ترسل اي شي رجاءا ."
...
@bot.on(events.NewMessage(incoming=True, from_users=(1614649021)))
async def hehehe(event):
    ...
    if event.is_private:
        if not pmpermit_sql.is_approved(chat.id):
            ...
            await borg.send_message(chat, "** أنـه مطـور الـسورس الخـاص بـك محمد **")
